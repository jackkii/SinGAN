...
def get_arguments():
    ...
    # 网络超参数
    parser.add_argument('--nfc', type=int, default=32)  # 卷积层通道数
    parser.add_argument('--min_nfc', type=int, default=32)  # 最小卷积层通道数（可能不需要？）
    ...
    parser.add_argument('--padd_size', type=int, help='net pad size', default=1)  # padding大小
    ...
    # 训练超参数
    parser.add_argument('--niter', type=int, help='number of epochs to train per scale', default=2)  # 训练回合
